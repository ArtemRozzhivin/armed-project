...
const Modal = ({
	className, title, message, isOpened, onClose, onSubmit, closeText, submitText, submitType, size, customButtons,
}) => (
	<Transition.Root show={isOpened} as={Fragment}>
		...
		>
          ...
          &#8203;
				...
				>
					<div
						className={cx('inline-block align-bottom bg-gray-200 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:px-5 sm:py-4', {
